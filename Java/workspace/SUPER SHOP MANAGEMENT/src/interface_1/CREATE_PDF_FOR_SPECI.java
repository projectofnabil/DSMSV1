...
public class CREATE_PDF_FOR_SPECI {
	private static String FILE1 = "D:/CASH_MEMO/SPECIFIC_NEWS.pdf";
...
//		    }
	  ...
	  public  void addTitlePage(int n,String product_id,String name,String unit_price,String quantity,String date)
	    ...
	    //addEmptyLine(preface, 1);
	    createTable(n,product_id,name,unit_price,quantity,date);
	  ...
	  private static void createTable(int n,String product_id,String name,String unit_price,String quantity,String date)
	      throws DocumentException {
	     table13 = new PdfPTable(5);
  ...
  table13.addCell(c113);
	    ...
	    c113.setHorizontalAlignment(Element.ALIGN_CENTER);
	    table13.addCell(c113);
	    c113 = new PdfPCell(new Phrase("DATE"));
	    c113.setHorizontalAlignment(Element.ALIGN_CENTER);
	    table13.addCell(c113);
...
for(int u=0;u<n;u++){
	    ...
	    table13.addCell(unit_price);
	    table13.addCell(quantity);
	    table13.addCell(date);
...
public  void add_table(int n,String product_id,String name,String unit_price,String quantity,String date) throws DocumentException{
			...
			try(
		      ...
		      Connection conn=Get_connection.getconnection(ENUM.MYSQL);
				...
				while(rs.next()){
					...
					String u=rs.getString("product_id");
					String 	s1=rs.getString("product_name");
					String	r=rs.getString("unit_price");
					String l=rs.getString("stock");
					String date=rs.getString("date");
					if(i==1){
					addTitlePage(1,s1,u,r,l,date);
			}
					else{
						add_table(1,s1, u,r,l,date);
					}++i;
